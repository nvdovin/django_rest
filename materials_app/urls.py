...
urlpatterns = [
    ...
    path('view_lesson_<int:pk>/', v.LessonRetrieveAPIView.as_view(), name='view_lesson'),
    path('delete_lesson_<int:pk>/', v.LessonDestroyAPIView.as_view(), name='delete_lesson'),
    path('update_lesson_<int:pk>/', v.LessonUpdateAPIView.as_view(), name='update_lesson'),
